...
function chartEvent(chart, _option, scope){
    ...
    $('#video-fullscreen').on('click',function(){
        ...
        var objId = chart['_dom'].id;
        $("#"+objId).height(pageheight);
        $("#"+objId).width(pagewidth );
        chart.resize();
    });
    $('#cancel-fullscreen').on('click',function(){
        setTimeout(function(){
            var pagewidth = $("#mario-video").width();
            var pageheight = $("#mario-video").height()-30;
            var objId = chart['_dom'].id;
            $("#"+objId).height(pageheight+'px');
            $("#"+objId).width(pagewidth+'px');
            chart.resize();
        },200);
    });
}